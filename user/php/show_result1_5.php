...
//connection to the result database to get specific result of an class
...
//getting Second TESTr marks of the student
...
//getting THIRD TEST marks of the student
...
//getting final year marks of the student
...
$ENGLISH_TOTAL = $D2_1english + $D2_2english + $D2_3english + $D2_4english + $D2_5english;
$MATH_TOTAL = $D2_1math + $D2_2math + $D2_3math + $D2_4math + $D2_5math;
$EVS_TOTAL = $D2_1evs + $D2_2evs + $D2_3evs + $D2_4evs + $D2_5evs;
$GK_TOTAL = $D2_1gk + $D2_2gk + $D2_3gk + $D2_4gk + $D2_5gk;

//TOATAL MARKS
$FINAL_TOTAL = $D2_1total + $D2_2total + $D2_3total + $D2_4total + $D2_5total;

// percentage
$percentage = $FINAL_TOTAL * 100 / 1000;
    ...
    <body>
        <div class='main'>
         ...
         <div class='SecondRow' id=''>
            <h3 name='R_ANNUAL_WORD'>Annual Results</h3>
         </div>
         ...
         <div class='FifthRow'>
            <table>
                ...
                <tr>
                    <th name='R_EVS'>EVS</th>
                    <td name='R_EVS_OBT_1ST'>$D2_1evs</td>
                    <td name='R_EVS_MAX_1ST'>10</td>
                    <td name='R_EVS_OBT_2ND'>$D2_2evs</td>
                    <td name='R_EVS_MAX_2ND'>10</td>
                    <td name='R_EVS_OBT_HALFYEARLY'>$D2_4evs</td>
                    <td name='R_EVS_MAX_HALFYEARLY'>70</td>
                    <td name='R_EVS_OBT_3RD'>$D2_3evs</td>
                    <td name='R_EVS_MAX_3RD'>10</td>
                    <td name='R_EVS_OBT_ANNUAL'>$D2_5evs</td>
                    <td name='R_EVS_MAX_ANNUAL'>100</td>
                    <td name='R_EVS_OBT_TOTAL'>$EVS_TOTAL</td>
                    <td name='R_EVS_MAX_TOTAL'>200</td>
                </tr>
                <tr>
                    <th name='R_GK'>G.K.</th>
                    <td name='R_GK_OBT_1ST'>$D2_1gk</td>
                    <td name='R_GK_MAX_1ST'>10</td>
                    <td name='R_GK_OBT_2ND'>$D2_2gk</td>
                    <td name='R_GK_MAX_2ND'>10</td>
                    <td name='R_GK_OBT_HALFYEARLY'>$D2_4gk</td>
                    <td name='R_GK_MAX_HALFYEARLY'>70</td>
                    <td name='R_GK_OBT_3RD'>$D2_3gk</td>
                    <td name='R_GK_MAX_3RD'>10</td>
                    <td name='R_GK_OBT_ANNUAL'>$D2_5gk</td>
                    <td name='R_GK_MAX_ANNUAL'>100</td>
                    <td name='R_GK_OBT_TOTAL'>$GK_TOTAL</td>
                    <td name='R_GK_MAX_TOTAL'>200</td>
                </tr>
                <tr>
                    <th name='R_TOTAL'>Total</th>
                    <td name='R_TOTAL_OBT_1ST'>$D2_1total</td>
                    <td name='R_TOTAL_MAX_1ST'>50</td>
                    <td name='R_TOTAL_OBT_2ND'>$D2_2total</td>
                    <td name='R_TOTAL_MAX_2ND'>50</td>
                    <td name='R_TOTAL_OBT_HALFYEARLY'>$D2_4total</td>
                    <td name='R_TOTAL_MAX_HALFYEARLY'>350</td>
                    <td name='R_TOTAL_OBT_3RD'>$D2_3total</td>
                    <td name='R_TOTAL_MAX_3RD'>50</td>
                    <td name='R_TOTAL_OBT_ANNUAL'>$D2_5total</td>
                    <td name='R_TOTAL_MAX_ANNUAL'>500</td>
                    <td name='R_TOTAL_OBT_GT'>$FINAL_TOTAL</td>
                    <td name='R_TOTAL_MAX_GT'>1000</td>
                </tr>
            </table>
            </div>
    
            <div class='SixthRow'>
            <span name='R_TOTALMARKS' class='sixthrow1'>Total Marks:&nbsp;&nbsp;1000</span>
